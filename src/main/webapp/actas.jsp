		...
		<section class="menu navbar-default menu05">
			...
			<nav class="navbar-collapse bs-navbar-collapse collapse"
				...
				<ul class="nav navbar-nav">
					<li class="bt-azul"><a href="svlPresidenciales">PRESIDENCIAL</a>
					</li>
			...
			<div class="row">
				<div class="col-xs-12 col-md-3">
					<div class="menu-interna">
						<ul>
							<li><a href="svlActas?tipo=Ubigeo" class="act-izq">Actas
									por ubigeo</a></li>
							<li><a href="svlActas?tipo=Numero">Actas por número</a></li>
						</ul>
					</div>
				</div>
				<p>&nbsp;<p/><p>&nbsp;<p/>
				<div class="col-xs-12 col-md-9" id="impreso">
					<div class="contenido-interna">
						...
						<% if (tipo == null || tipo.equals("Ubigeo")){ %>
							...
							<form id="frmBuscar" name="frmBuscar" action="svlActas"
											...
											<div id="departamentos">
												<select name="cboDepartamento" id="cboDepartamento"
													...
													<% if(session.getAttribute("departamentos") != null){
                                                    	String[][] departamentos = (String[][]) session.getAttribute("departamentos");
                                                    	for(String[] aDepartamento : departamentos){
                                                    %>
													<option
								...
								<div class="row">
									<div class="col-md-4">
										...
										<div id="distritos">
											<select name="cboDistritos" id="cboDistritos" class="form-control" onChange="javascript:document.frmBuscar.submit()"
											<%= aDPD[1].equals("-1") ? "disabled" : "" %>>
												...
												<% if(session.getAttribute("distritos") != null){
                                                    	...
                                                    	for(String[] aDistritos : mDistritos){
                                                %>
												<option
													<%=( aDPD[2].equals(aDistritos[0]) ? "selected" : "") %>
													value="<%= aDistritos[0]%>"><%= aDistritos[1] %></option>
												<%}} %>
											</select>
										</div>
									</div>
									<div class="col-md-8">
										<div class="form-group">
											...
											<div id="locales">
												<select name="cboLocalVotacion" id="cboLocalVotacion"
													class="form-control" onChange="javascript:document.frmBuscar.submit()"
										...
										<div class="col-xs-12 pbot30">
											...
											<div id="page-wrap">
												<table class="table17" cellspacing="0">
													...
													<tbody>
														<% String[] aMesas = (String[]) session.getAttribute("grupos");
															int mesas = 10;
															...
															<td bgcolor="#C1C1C1"
																onclick="verDetalleMesa('210501', '065894', '10', '1')"
																style="cursor: pointer"><a href="svlActas?nroMesa=<%=mesa%>"><%=mesa%></a></td>
															<% if(mesas % 10 == 0) { %> </tr> <% }%>	
														...
														<tbody>
															<tr>
																<td colspan="10"><div class="conte-paginador">
																		<span class="paginador-txt">Total de mesas: <%=((String[]) session.getAttribute("grupos")).length %></span>
																	</div></td>
															</tr>
															<tr>
																<td>&nbsp;</td>
