...
<html>
	...
	<body>
		...
		<div id="imprimelo3">
			<div class="container">
				<img src="images/f-participacion.jpg" width="1170" height="248"
				...
				<section class="menu navbar-default menu05">
					...
					<nav class="navbar-collapse bs-navbar-collapse collapse"
						...
						<ul class="nav navbar-nav">
							...
							<li class="bt-rojo act-rojo"><a href="svlParticipacion">PARTICIPACIÓN
									CIUDADANA</a></li>
						</ul>
					</nav>
				</section>
								...
								<div class="titulos col-xs-12">
									<div class="col-xs-11">
										<h3>
											...
											ELECCIÓN PRESIDENCIAL 2016: PARTICIPACIÓN CIUDADANA
										</h3>
									</div>
								</div>
								<div class="col-xs-12">
